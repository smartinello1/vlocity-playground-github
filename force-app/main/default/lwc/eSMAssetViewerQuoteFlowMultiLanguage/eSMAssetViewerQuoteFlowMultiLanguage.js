...
import { OMNIDEF } from './eSMAssetViewerQuoteFlowMultiLanguage_def.js';
import tmpl from './eSMAssetViewerQuoteFlowMultiLanguage.html';
import tmpl_nds from './eSMAssetViewerQuoteFlowMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMAssetViewerQuoteFlowMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
