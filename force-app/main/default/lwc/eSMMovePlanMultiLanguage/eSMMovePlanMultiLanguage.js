...
import { OMNIDEF } from './eSMMovePlanMultiLanguage_def.js';
import tmpl from './eSMMovePlanMultiLanguage.html';
import tmpl_nds from './eSMMovePlanMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMMovePlanMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
